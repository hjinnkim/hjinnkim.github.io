var store = [{
        ...
        "excerpt":"🦥 본문   Linear Algebra Linear Algebra   Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra Linear Algebra  ","categories": ["Linear Algebra"],
        "tags": ["tag1","tag2"],
        ...
        "title": "[Jekyll] 02. Math symbol",
        "excerpt":"1. 참고   https://chaelin0722.github.io/blog/mathjex/  ","categories": ["Blog"],
        "tags": ["Jekyll","Markdown","LaTeX"],
        "url": "/blog/blog/002/",
        "teaser": null
      },{
        "title": "[Jekyll] 03. Unpublish posts",
        "excerpt":"1. published option   다음 옵션을 비공개하고 싶은 포스트의 설정 부분에 추가한다.     published: false   2. local environment   비공개 포스트는 기본적으로 로컬 블로그에서도 비공개처리 된다. 해당 비공개 포스트를 확인하기 위해서는 다음 명령어를 통해 로컬 블로그를 실행시켜야 한다.     bundle exec jekyll serve --unpublished  ","categories": ["Blog"],
        "tags": ["Jekyll"],
        "url": "/blog/blog/003/",
        "teaser": null
      },{
        "title": "Have to study",
        "excerpt":"What I have to study for blog setup           Posts order setup       Not by date or title, but manually order posts            Adjusting side space       It is too narrow for body contents.            Image caption       It is too ugly… Have to study how to change font (size, color, bold…)          ","categories": ["Blog"],
        "tags": ["Jekyll"],
        "url": "/blog/blog/000/",
        "teaser": null
      },{
        "title": "[Philosophy of Science] 00. Introduction",
        "excerpt":"Introduction of Philosophy of Science   해당 카테고리의 포스트들은 개인 학습을 위한 포스트들이며, 저작권 보호를 위해 포스트를 비공개로 게시합니다.  ","categories": ["Ph of Science"],
        "tags": [],
        ...
        "excerpt":"Part 1 딥러닝의 기초 0. Table of Contents Neural Networks Convolutional Neural Networks Recurrent Neural Networks Autoencoders 1. Neural Networks (신경망) 생물학적 뉴런을 인공적으로 모방한 모델. (1943년 W. McCulloch에 의해 소개되었음) 퍼셉트론은 활성화 함수가 계단 함수(Step Function)인 모델. (1957년 F. Rosenblatt에 의해 소개되었음) 퍼셉트론은 간단한 XOR 문제를 풀지 못하는 한계를...","categories": ["GNN"],
        "tags": ["Deep Learning","GNN"],
        "url": "/courses/gnn/001/",
        "teaser": null
      },{
        "title": "[GNN] 02. Graph Basics",
        "excerpt":"Part 2 그래프의 기초 0. Table of Contents Why Graph? Graph Representation Properties and Measures of Graph Spectral Graph Theory Graph Signal Processing 1. Why Graph? 그래프(Graph)는 실제 데이터를 표현하는데 가장 필수적인 방법. 실제로 많이 쓰이기 때문에 여러 분야에서 연구됨. 2. Graph Representation 그래프는 다음과 같이 표현된다. $G={V, E}$ where...","categories": ["GNN"],
        "tags": ["Graph","GNN"],
        "url": "/courses/gnn/002/",
        "teaser": null
      },{
        "title": "[GNN] 03. Graph Neural Networks",
        "excerpt":"Part 3 그래프 신경망 기초 0. Table of Contents Introduction and Motivation of GNNs GNN Frameworks Spectral Graph Convolution Spatial Graph Convolution Graph Pooling Framework Graph Filters in Detail 1. Introduction and Motivation of GNNs 실제 데이터는 graph-based인 경우가 많다. GNN은 Scarselli et al.(2009)에 의해 제시되었으며, 딥러닝을 그래프 형태의 데이터에...","categories": ["GNN"],
        "tags": ["Graph","GNN"],
        "url": "/courses/gnn/003/",
        "teaser": null
      },{
